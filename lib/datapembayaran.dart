...
import 'tambahdatapembayaran.dart';

class DataPembayaranPage extends StatefulWidget {
  const DataPembayaranPage({Key? key}) : super(key: key);

  @override
  _DataPembayaranPageState createState() => _DataPembayaranPageState();
}
        ...
        child: ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              ...
              Text('spp_bayar: ${_listPembayaran[index]['spp_bulan']}'),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: ((context) => TambahPembayaranPage())));
        },
      ), 
